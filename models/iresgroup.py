...
def iresgroup101(init, pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        if init.server == 'Dorchester':
            checkpoint_path = '/homes/gh653/Projects/mae/models/iresgroup101.pth'
        else:
            checkpoint_path = '/data/home/acw779/Projects/Code/mae/models/iresgroup101.pth'
